                ...
                return {
                    start: function(k) {
                        ...
                        a.get(f, {
                            ...
                            "error" != a.result && ("dev" === e ? h._setupPopupSignupForm(a, n, c, e) : require(["//downloads.mailchimp.com/js/signup-forms/popup/" + a.version + "/popup.js"], function() {
                                h._setupPopupSignupForm(a, n, c, e)
                            }))
                        })
                    },
                    _getFormSettingsUrl: function(a, f, n) {
                        return "//" + a + "/subscribe/form-settings?u\x3d" + f + "\x26id\x3d" + n
                    },
